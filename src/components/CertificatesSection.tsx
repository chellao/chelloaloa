...
const certificates = [
  {
    title: '3rd Place Singles Tennis',
    issuer: 'District Level Competition',
    date: '2024',
    credentialId: 'TEN-SGL-003',
    image: '🎾',
    color: 'from-green-500/20 to-lime-500/20',
    link: '#',
  },
  {
    title: '2nd Place Doubles Tennis',
    issuer: 'District Level Competition',
    date: '2024',
    credentialId: 'TEN-DBL-002',
    image: '🏅',
    color: 'from-yellow-500/20 to-orange-500/20',
    link: '#',
  },
  {
    title: '3rd Place Popda',
    issuer: 'Popda Competition',
    date: '2024',
    credentialId: 'POPDA-003',
    image: '🥉',
    color: 'from-orange-500/20 to-amber-500/20',
    link: '#',
  },
  {
    title: 'Student at MAN 1 Banda Aceh',
    issuer: 'MAN 1 Banda Aceh',
    date: 'Present',
    credentialId: 'STUDENT-001',
    image: '🎓',
    color: 'from-blue-500/20 to-indigo-500/20',
    link: '#',
  },
  {
    title: 'Gaming & Personal Interests',
    issuer: 'Personal Development',
    date: 'Ongoing',
    credentialId: 'HOBBY-001',
    image: '🎮',
    color: 'from-purple-500/20 to-pink-500/20',
    link: '#',
  },
  {
    title: 'Active in Sports (Tennis)',
